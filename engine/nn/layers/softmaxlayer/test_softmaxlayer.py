...
class TestSigmoidLayer(unittest.TestCase):
    ...
    def test_reach_imagestar(self):
        ...
        test_V = np.reshape(read_csv_data(sources[SOFTMAXL_TEST_RSI_INIT][SOFTMAXL_TEST_RSI_IMGSTAR_V_ID]), (28,28,1,785))
        test_C = np.reshape(read_csv_data(sources[SOFTMAXL_TEST_RSI_INIT][SOFTMAXL_TEST_RSI_IMGSTAR_C_ID]), (1, 784))
        test_d = np.array([read_csv_data(sources[SOFTMAXL_TEST_RSI_INIT][SOFTMAXL_TEST_RSI_IMGSTAR_D_ID])])
        test_predicate_lb = read_csv_data(sources[SOFTMAXL_TEST_RSI_INIT][SOFTMAXL_TEST_RSI_IMGSTAR_PREDICATE_LB_ID])
        test_predicate_ub = read_csv_data(sources[SOFTMAXL_TEST_RSI_INIT][SOFTMAXL_TEST_RSI_IMGSTAR_PREDICATE_UB_ID])
        test_im_lb = read_csv_data(sources[SOFTMAXL_TEST_RSI_INIT][SOFTMAXL_TEST_RSI_IMGSTAR_IM_LB_ID])
        test_im_ub = read_csv_data(sources[SOFTMAXL_TEST_RSI_INIT][SOFTMAXL_TEST_RSI_IMGSTAR_IM_UB_ID])
    ...
    def test_reach_star_multiple_inputs_imagestar(self):
        test_name = 'sigmoid_1'
        test_num_inputs = 1
        test_input_names = ['in']
        test_num_outputs = 1
    ...
    def test_reach_star_single_input_imagestar(self):
        test_name = 'sigmoid_1'
        test_num_inputs = 1
        test_input_names = ['in']
        test_num_outputs = 1
