...
class TestFFNNVerify(unittest.TestCase):
    """
        Tests FFNN_verify function
    """
    ...
    def test_FFNN(self):
        ...
        [safe, vt, counterExs] = F.verify(I, U, 'exact-star', 1, 20)
        print("\n safe ------------------------ \n", safe)
        print("\n vt ------------------------ \n", vt)
        print("\n counterExs ------------------------ \n", counterExs.__repr__())
...
# ------------- End the test for FFNN_verify function -------------
