...
class TestFFNNVerifyDFSSingleCore(unittest.TestCase):
    ...
    def test_FFNN_verify_DFS(self):
        ...
        L2 = Layer(W2, b2, 'satlin') # construct second layer
        print("\n L2 satlin ------------------------ \n", L2.__repr__())
        ...
        [safe, CEx] = F.verify_F_DFS_SingleCore('InputSet', I, 'UnsafeRegion', U)
        print("\n safe ------------------------ \n", safe)
        print("\n CEx ------------------------ \n", CEx.__repr__())

        [safe1, CEx1] = F.verify_F_DFS_SingleCore('InputSet', I, 'UnsafeRegion', U, 'ReachMethod', 'approx-star')
        print("\n safe1 ------------------------ \n", safe1)
        print("\n CEx1 ------------------------ \n", CEx1.__repr__())
