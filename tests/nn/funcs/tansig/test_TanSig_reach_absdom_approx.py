...
class TestTanSigReachAbsdomApporx(unittest.TestCase):
    """
        Tests Abstract domain approximation of hyperbolic tanget function by a Star
    """
    def test_reach_absdom_approx(self):
        """
            First, a Star is created using lower and upper bounds.
            The created Star is affine mapped. 
            Then, an absdom approximation of TanSig function is applied.
        ...
        S_activation = TanSig.reach_absdom_approx(S_affine)
