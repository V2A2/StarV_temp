# ------------- test for reach_relaxed_star_ub function -------------
import unittest
...
class TestPosLinReachRelaxedStarUb(unittest.TestCase):
    """
        Tests PosLin reach_relaxed_star_ub function
    """
    ...
    def test_reach_star_approx(self):
        ...
        S = PosLin.reach_relaxed_star_ub(I, 0.5, '', 'display')
        print("\n S ------------------------ \n", S.__repr__())
...
# ------------- end of the test for reach_relaxed_star_ub function -------------
