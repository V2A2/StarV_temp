# ------------- test for reach_relaxed_star_range function -------------
import unittest
...
class TestPosLinReachRelaxedStarRange(unittest.TestCase):
    """
        Tests PosLin reach_relaxed_star_range function
    """
    ...
    def test_reach_star_approx(self):
        ...
        S = PosLin.reach_relaxed_star_range(I, 0.5, '', 'display')
        print("\n S ------------------------ \n", S.__repr__())
...
# ------------- end of the test for reach_relaxed_star_range function -------------
