...
class TestLogSigReachZonoApporx(unittest.TestCase):
    """
        Tests approximation of logistic sigmoid function by a zonotope
    """
    def test_reach_zono_approx(self):
        """
            First, a zonotope is created using a Box.
            The created zonotope is affine mapped. 
            Then, an approximation of LogSig function is applied.
        ...
        Z_activation = LogSig.reach_zono_approx(Z_affine)
