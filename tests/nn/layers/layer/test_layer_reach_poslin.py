# ------------- test for Layer reach poslin function -------------
import unittest
import numpy as np
import sys
...
class TestLayerReachPosLin(unittest.TestCase):
    """
        Tests Layer reach poslin function
    """

    def test_reach_poslin(self):
...
# ------------- end the test for Layer reach poslin function -------------
