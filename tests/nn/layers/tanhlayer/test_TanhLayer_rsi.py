...
class TestSigmoidLayer_rsi(unittest.TestCase):
    ...
    #                               test_output_names)
    #
    #     test_V = read_csv_data(sources[SIGMOIDL_TEST_RSI_INIT][SIGMOIDL_TEST_RSI_STAR_V_ID])
    #     test_C = np.reshape(read_csv_data(sources[SIGMOIDL_TEST_RSI_INIT][SIGMOIDL_TEST_RSI_STAR_C_ID]), (1, 784))
    #     test_d = np.array([read_csv_data(sources[SIGMOIDL_TEST_RSI_INIT][SIGMOIDL_TEST_RSI_STAR_D_ID])])
    #     test_predicate_lb = read_csv_data(sources[SIGMOIDL_TEST_RSI_INIT][SIGMOIDL_TEST_RSI_STAR_PREDICATE_LB_ID])
    #     test_predicate_ub = read_csv_data(sources[SIGMOIDL_TEST_RSI_INIT][SIGMOIDL_TEST_RSI_STAR_PREDICATE_UB_ID])
    #
    #     test_star = Star(
